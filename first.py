...
#for i in range(13):
 #   print(rl[i])
  #  with keyboard.Listener(on_press=on_press, on_release=on_release) as llistener:
   #     llistener.join()
    #sleep(1)
wl=[(1645, 134), (1692, 215), (1055, 787), (996, 119), (1041, 361), (1487, 874), (1298, 522), (1731, 862), (1631, 772), (1885, 830), (822, 172), (1460, 223), (1712, 179)]
print(wl)
...
print(ask_ai(see_what_say("希沃云班",11968,"you")))
tt=0.5
i=0
